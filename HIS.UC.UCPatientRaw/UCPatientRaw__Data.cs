    ...
    public partial class UCPatientRaw : UserControl
    {
            ...
            try
            {
                if (dataSet != null)
                {
                    ...
                    if (career != null)
                    {
                        ...
                        Inventec.Common.Logging.LogSystem.Info("SetValue:" + this.txtCareerCode.Text);
        ...
        private void FillDataCareerUnder6AgeByHeinCardNumber(string heinCardNumder)
        {
            try
            {
                ...
                {
                    //this.txtCareerCode.Text = career.CAREER_CODE;
                    //Inventec.Common.Logging.LogSystem.Info("FillDataCareerUnder6AgeByHeinCardNumber:" + this.txtCareerCode.Text);
                    //this.cboCareer.EditValue = career.ID;
                }
            }
            catch (Exception ex)
