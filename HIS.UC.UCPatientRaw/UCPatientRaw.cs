        ...
        private void SetValueCareerComboByCondition()
        {
            try
            {
                ...
                if (career != null)
                {
                    ...
                    Inventec.Common.Logging.LogSystem.Info("SetValueCareerComboByCondition:" + this.txtCareerCode.Text);
                ...
                if (e.KeyCode == Keys.Enter)
                {
                    ...
                    else
                    {
                        ...
                        if (searchResult != null && searchResult.Count == 1)
                        {
                            ...
                            Inventec.Common.Logging.LogSystem.Info("txtCareerCode_PreviewKeyDown:" + this.txtCareerCode.Text);
                            if (this.TD3)
                            {
        ...
        private void cboCareer_Closed(object sender, ClosedEventArgs e)
        {
            try
            {
                ...
                if (this.cboCareer.EditValue != null)
                {
                    ...
                    {
                        this.txtCareerCode.Text = career.CAREER_CODE;
                        Inventec.Common.Logging.LogSystem.Info("cboCareer_Closed:" + this.txtCareerCode.Text);
                    }
                    if (this.TD3)
                    {
                        this.dlgFocusNextUserControl();
            ...
            try
            {
                if (e.KeyCode == Keys.Enter)
                {
                    if (this.cboCareer.EditValue != null)
                    {
                        ...
                        {
                            this.txtCareerCode.Text = career.CAREER_CODE;
                            Inventec.Common.Logging.LogSystem.Info("cboCareer_KeyUp:" + this.txtCareerCode.Text);
                        }
                    }
                    else
                    {
        ...
        private void cboCareer_EditValueChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                if (this.cboCareer.EditValue != null)
                {
                    ...
                    {
                        this.txtCareerCode.Text = career.CAREER_CODE;
                        Inventec.Common.Logging.LogSystem.Info("cboCareer_EditValueChanged1:" + this.txtCareerCode.Text);
                    }
                    else
                    {
                        cboCareer.EditValue = null;
                        this.txtCareerCode.Text = null;
                        Inventec.Common.Logging.LogSystem.Info("cboCareer_EditValueChanged11:" + this.txtCareerCode.Text);
                    }
                ...
                {
                    this.txtCareerCode.Text = null;
                    Inventec.Common.Logging.LogSystem.Info("cboCareer_EditValueChanged111:" + this.txtCareerCode.Text);
                }
