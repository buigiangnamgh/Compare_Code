        ...
        private List<XML3ADO> ProcessDetailsData(InputXml3ADO data)
        {
            ...
            try
            {
                ...
                foreach (var hisSereServ in listServeservs)
                {
                    ...
                    Inventec.Common.Logging.LogSystem.Debug("NgayYLenhOption: " + NgayYLenhOption);
                    Inventec.Common.Logging.LogSystem.Debug("hisSereServ.TDL_SERVICE_TYPE_ID: " + NgayYLenhOption);
