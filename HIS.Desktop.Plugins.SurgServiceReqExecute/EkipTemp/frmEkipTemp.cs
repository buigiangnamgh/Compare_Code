...
namespace HIS.Desktop.Plugins.SurgServiceReqExecute.EkipTemp
{
	public class frmEkipTemp : Form
	{
		...
		private CheckEdit chkDepartment;

		private LayoutControlItem layoutControlItem5;

		private List<HisEkipUserADO> ekipUsers { get; set; }
		...
		private void btnSave_Click(object sender, EventArgs e)
		{
			...
			try
			{
				...
				if (currentModule.RoomId > 0)
				{
					long departmentId = WorkPlace.WorkPlaceSDO.FirstOrDefault((WorkPlaceSDO o) => o.RoomId == currentModule.RoomId).DepartmentId;
					val2.DEPARTMENT_ID = departmentId;
					val2.IS_PUBLIC_IN_DEPARTMENT = (chkPublicDepartment.Checked ? new short?(1) : ((short?)null));
				}
				else
				{
					val2.DEPARTMENT_ID = null;
					chkPublicDepartment.Checked = false;
					chkPublicDepartment.Enabled = false;
					chkPublicDepartment.ToolTip = " Để sử dụng tính năng này, bạn cần mở chức năng \"kíp mẫu\" từ phòng làm việc";
				}
				foreach (HisEkipUserADO ekipUser in ekipUsers)
				{
					...
					{
						val3.DEPARTMENT_ID = ((V_HIS_EKIP_USER)ekipUser).DEPARTMENT_ID;
					}
					else
					{
						val3.DEPARTMENT_ID = null;
					}
		...
		private void SetCaptionByLanguageKey()
		{
			try
			{
				ResourceLanguageManager.LanguageResource__frmEkipTemp = new ResourceManager("HIS.Desktop.Plugins.SurgServiceReqExecute.Resources.Lang", typeof(frmEkipTemp).Assembly);
				layoutControl1.Text = Inventec.Common.Resource.Get.Value("frmEkipTemp.layoutControl1.Text", ResourceLanguageManager.LanguageResource__frmEkipTemp, LanguageManager.GetCulture());
				chkDepartment.Properties.Caption = Inventec.Common.Resource.Get.Value("frmEkipTemp.chkDepartment.Properties.Caption", ResourceLanguageManager.LanguageResource__frmEkipTemp, LanguageManager.GetCulture());
				chkDepartment.ToolTip = Inventec.Common.Resource.Get.Value("frmEkipTemp.chkDepartment.ToolTip", ResourceLanguageManager.LanguageResource__frmEkipTemp, LanguageManager.GetCulture());
				bar1.Text = Inventec.Common.Resource.Get.Value("frmEkipTemp.bar1.Text", ResourceLanguageManager.LanguageResource__frmEkipTemp, LanguageManager.GetCulture());
				barButtonItem1.Caption = Inventec.Common.Resource.Get.Value("frmEkipTemp.barButtonItem1.Caption", ResourceLanguageManager.LanguageResource__frmEkipTemp, LanguageManager.GetCulture());
				chkPublicDepartment.Properties.Caption = Inventec.Common.Resource.Get.Value("frmEkipTemp.chkPublicDepartment.Properties.Caption", ResourceLanguageManager.LanguageResource__frmEkipTemp, LanguageManager.GetCulture());
				chkPublic.Properties.Caption = Inventec.Common.Resource.Get.Value("frmEkipTemp.chkPublic.Properties.Caption", ResourceLanguageManager.LanguageResource__frmEkipTemp, LanguageManager.GetCulture());
				btnSave.Text = Inventec.Common.Resource.Get.Value("frmEkipTemp.btnSave.Text", ResourceLanguageManager.LanguageResource__frmEkipTemp, LanguageManager.GetCulture());
				layoutControlItem2.Text = Inventec.Common.Resource.Get.Value("frmEkipTemp.layoutControlItem2.Text", ResourceLanguageManager.LanguageResource__frmEkipTemp, LanguageManager.GetCulture());
				layoutControlItem1.Text = Inventec.Common.Resource.Get.Value("frmEkipTemp.layoutControlItem1.Text", ResourceLanguageManager.LanguageResource__frmEkipTemp, LanguageManager.GetCulture());
				layoutControlItem4.Text = Inventec.Common.Resource.Get.Value("frmEkipTemp.layoutControlItem4.Text", ResourceLanguageManager.LanguageResource__frmEkipTemp, LanguageManager.GetCulture());
				layoutControlItem5.Text = Inventec.Common.Resource.Get.Value("frmEkipTemp.layoutControlItem5.Text", ResourceLanguageManager.LanguageResource__frmEkipTemp, LanguageManager.GetCulture());
				Text = Inventec.Common.Resource.Get.Value("frmEkipTemp.Text", ResourceLanguageManager.LanguageResource__frmEkipTemp, LanguageManager.GetCulture());
			}
			catch (Exception ex)
			{
				LogSystem.Warn(ex);
		...
		private void InitializeComponent()
		{
			...
			this.layoutControlGroup1.Items.AddRange(new DevExpress.XtraLayout.BaseLayoutItem[6] { this.layoutControlItem2, this.layoutControlItem3, this.emptySpaceItem1, this.layoutControlItem1, this.layoutControlItem4, this.layoutControlItem5 });
		...
		private void ValidateControlTextEdit(TextEdit textEdit)
		{
			...
			try
			{
				...
				val.editor = textEdit;
				((ValidationRuleBase)(object)val).ErrorText = HIS.Desktop.LibraryMessage.MessageUtil.GetMessage((LibraryMessage.Message.Enum)48);
