...
namespace HIS.Desktop.Plugins.SurgServiceReqExecute.PtttMethod
{
	public class FormPtttMethod : FormBase
	{
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(FormPtttMethod));
			...
			{
				new EditorButton(ButtonPredefines.Glyph, "", -1, true, true, false, ImageLocation.MiddleCenter, (Image)componentResourceManager.GetObject("BbtnUser_PTTT.Buttons"), new KeyShortcut(Keys.None), appearance, appearanceHovered, appearancePressed, appearanceDisabled, "Kíp", null, null, true)
			});
			...
			{
				new EditorButton(ButtonPredefines.Glyph, "", -1, true, true, false, ImageLocation.MiddleCenter, (Image)componentResourceManager.GetObject("BbtnUnCheck.Buttons"), new KeyShortcut(Keys.None), appearance2, appearanceHovered2, appearancePressed2, appearanceDisabled2, "", null, null, true)
			});
			...
			{
				new EditorButton(ButtonPredefines.Glyph, "", -1, true, true, false, ImageLocation.MiddleCenter, (Image)componentResourceManager.GetObject("BbtnCheck.Buttons"), new KeyShortcut(Keys.None), appearance3, appearanceHovered3, appearancePressed3, appearanceDisabled3, "", null, null, true)
			});
			...
			imageCollection1.ImageStream = (ImageCollectionStreamer)componentResourceManager.GetObject("imageCollection1.ImageStream");
