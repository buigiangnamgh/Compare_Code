...
namespace Inventec.Common.SignFile
{
	public class SignPdfAsynchronous
	{
		...
		{
			_003C_003Ec__DisplayClass9_0 CS_0024_003C_003E8__locals79 = new _003C_003Ec__DisplayClass9_0();
			CS_0024_003C_003E8__locals79.displayConfig = displayConfig;
			CS_0024_003C_003E8__locals79.strDate = strDate;
			CS_0024_003C_003E8__locals79.displayText = string.Empty;
			try
			{
				LogSystem.Info(LogUtil.TraceData(LogUtil.GetMemberName<DisplayConfig>((Expression<Func<DisplayConfig>>)(() => CS_0024_003C_003E8__locals79.displayConfig)), (object)CS_0024_003C_003E8__locals79.displayConfig) + LogUtil.TraceData(LogUtil.GetMemberName<string>(Expression.Lambda<Func<string>>(Expression.Field(Expression.Constant(CS_0024_003C_003E8__locals79, typeof(_003C_003Ec__DisplayClass9_0)), FieldInfo.GetFieldFromHandle((RuntimeFieldHandle)/*OpCode not supported: LdMemberToken*/)), new ParameterExpression[0])), (object)CS_0024_003C_003E8__locals79.strDate));
				if (CS_0024_003C_003E8__locals79.displayConfig.DisplayText != null && CS_0024_003C_003E8__locals79.displayConfig.DisplayText.Length != 0)
				{
					CS_0024_003C_003E8__locals79.displayText = CS_0024_003C_003E8__locals79.displayConfig.DisplayText;
				}
				else
				{
					...
					string text = "";
					string text2 = "";
					if (!string.IsNullOrEmpty(CS_0024_003C_003E8__locals79.displayConfig.Location) && CS_0024_003C_003E8__locals79.displayConfig.Location.Contains("|"))
					{
						string[] array = CS_0024_003C_003E8__locals79.displayConfig.Location.Split(new string[1] { "|" }, StringSplitOptions.RemoveEmptyEntries);
					...
					{
						text = CS_0024_003C_003E8__locals79.displayConfig.Location;
						if (CS_0024_003C_003E8__locals79.displayConfig.Titles != null && CS_0024_003C_003E8__locals79.displayConfig.Titles.Length != 0)
						{
							text2 = CS_0024_003C_003E8__locals79.displayConfig.Titles[0];
						}
					}
					if (CS_0024_003C_003E8__locals79.displayConfig.FormatRectangleText == Constans.SIGN_TEXT_FORMAT_3__NO_DATE || CS_0024_003C_003E8__locals79.displayConfig.FormatRectangleText == Constans.SIGN_TEXT_FORMAT_USER)
					{
						list.Add(CS_0024_003C_003E8__locals79.displayConfig.Contact.Replace("\\", ""));
						...
						if (CS_0024_003C_003E8__locals79.displayConfig.IsDisplaySignNote.HasValue && CS_0024_003C_003E8__locals79.displayConfig.IsDisplaySignNote.Value && !string.IsNullOrEmpty(CS_0024_003C_003E8__locals79.displayConfig.Reason))
						{
							list2.Add(Constans.SIGN_TEXT_FORMAT_REASON.Replace("0", list2.Count.ToString()));
							list.Add(CS_0024_003C_003E8__locals79.displayConfig.Reason);
						}
						CS_0024_003C_003E8__locals79.displayConfig.FormatRectangleText = string.Join("\r\n", list2);
					}
					else if (CS_0024_003C_003E8__locals79.displayConfig.FormatRectangleText == Constans.SIGN_TEXT_FORMAT_3__NO_TITLE)
					{
						list.Add(CS_0024_003C_003E8__locals79.displayConfig.Contact.Replace("\\", ""));
						list2.Add(Constans.SIGN_TEXT_FORMAT_USER.Replace("0", list2.Count.ToString()));
						list.Add(CS_0024_003C_003E8__locals79.strDate);
					...
					{
						if (CS_0024_003C_003E8__locals79.displayConfig.FormatRectangleText == "2")
						{
							list.Add(CS_0024_003C_003E8__locals79.displayConfig.Contact.Replace("\\", ""));
							list2.Add(Constans.SIGN_TEXT_FORMAT_USER.Replace("0", list2.Count.ToString()));
							if (!string.IsNullOrEmpty(text2))
						...
						else if (CS_0024_003C_003E8__locals79.displayConfig.FormatRectangleText == "3")
						{
							list.Add(CS_0024_003C_003E8__locals79.displayConfig.Contact.Replace("\\", ""));
							list2.Add(Constans.SIGN_TEXT_FORMAT_USER.Replace("0", list2.Count.ToString()));
							list.Add(CS_0024_003C_003E8__locals79.strDate);
						...
						else if (CS_0024_003C_003E8__locals79.displayConfig.FormatRectangleText == "4")
						{
							list.Add(CS_0024_003C_003E8__locals79.displayConfig.Contact.Replace("\\", ""));
							list2.Add(Constans.SIGN_TEXT_FORMAT_USER.Replace("0", list2.Count.ToString()));
							list.Add(CS_0024_003C_003E8__locals79.strDate);
						...
						else if (CS_0024_003C_003E8__locals79.displayConfig.FormatRectangleText == "5")
						{
							list.Add(CS_0024_003C_003E8__locals79.displayConfig.Contact.Replace("\\", ""));
							list2.Add(Constans.SIGN_TEXT_FORMAT_USER.Replace("0", list2.Count.ToString()));
							if (!string.IsNullOrEmpty(text))
						...
						else if (CS_0024_003C_003E8__locals79.displayConfig.FormatRectangleText == "6")
						{
							...
							text3 += CS_0024_003C_003E8__locals79.displayConfig.Contact.Replace("\\", "").Trim();
							list.Add(text3);
							list2.Add("{0}");
						}
						else if (CS_0024_003C_003E8__locals79.displayConfig.FormatRectangleText == "7")
						{
							list.Add(CS_0024_003C_003E8__locals79.displayConfig.Contact.Replace("\\", ""));
							list2.Add("{0}");
						}
					...
					CS_0024_003C_003E8__locals79.displayText = string.Format(CS_0024_003C_003E8__locals79.displayConfig.FormatRectangleText, list.ToArray());
				}
				LogSystem.Info(LogUtil.TraceData(LogUtil.GetMemberName<string>((Expression<Func<string>>)(() => CS_0024_003C_003E8__locals79.displayConfig.FormatRectangleText)), (object)CS_0024_003C_003E8__locals79.displayConfig.FormatRectangleText) + LogUtil.TraceData(LogUtil.GetMemberName<string>((Expression<Func<string>>)(() => CS_0024_003C_003E8__locals79.displayText)), (object)CS_0024_003C_003E8__locals79.displayText));
			}
			catch (Exception ex)
			{
				CS_0024_003C_003E8__locals79.displayText = Constans.SIGN_TEXT_FORMAT_3_1;
				LogSystem.Warn("Error GetDisplayText: " + ex.Message);
			}
			return CS_0024_003C_003E8__locals79.displayText;
		}
		...
		public bool EmptySignatureTable(string inFile, string outFile, string fieldName, DisplayConfig displayConfig, X509Certificate cert)
		{
			...
			try
			{
				...
				{
					IList<FieldPosition> fieldPositions = acroFields.GetFieldPositions(signatureName);
