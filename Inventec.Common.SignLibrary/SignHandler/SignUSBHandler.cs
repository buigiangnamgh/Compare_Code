                        ...
                        if (cert != null)
                        {
                            ...
                            if (!String.IsNullOrEmpty(src))
                            {
                                ...
                                if (this.FileType == SignLibrary.FileType.Xml)
                                {
                                    ...
                                    {
                                        //success = signer.SignXml(cert, src, memoStream, signReason, "", displayConfig, null, ref errMessage, GlobalStore.PIN); nambg comment
                                    }
                                }
                                else if (this.FileType == SignLibrary.FileType.Json)
                                {
                            ...
                            {
                                //success = signer.SignPDF(cert, stream, outputName, signReason, "", timestampConfig, displayConfig, null, ref errMessage);
                                //if (this.FileType == SignLibrary.FileType.Xml)
                                //{
                                //    using (var memoStream = new MemoryStream())
                                //    {
                                //        success = signer.SignXml(cert, stream, memoStream, signReason, "", displayConfig, null, ref errMessage, GlobalStore.PIN);
                                //    }
                                //}
                                //else if (this.FileType == SignLibrary.FileType.Json)
                                //{
                                //    using (var memoStream = new MemoryStream())
                                //    {
                                //        success = signer.SignJson(cert, stream, memoStream, signReason, "", displayConfig, null, ref errMessage, GlobalStore.PIN);
                                //    }
                                //}
                                //else
                                //{
