...
namespace Inventec.Common.SignLibrary.ADO
{
	public class InputADO
	{
		...
		public short? IsOutsideTreatment { get; set; }
		...
		public PaperSize PaperSizeDefault { get; set; }
		...
		{
			DlgChoosePoint = dlgChoosePoint;
			IsSelectRangeRectangle = isSelectRangeRectangle;
