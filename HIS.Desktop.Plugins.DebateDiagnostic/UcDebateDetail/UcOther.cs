...
namespace HIS.Desktop.Plugins.DebateDiagnostic.UcDebateDetail
{
	public class UcOther : UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(HIS.Desktop.Plugins.DebateDiagnostic.UcDebateDetail.UcOther));
			...
			this.gridControlContainerActiveIngredient = new CustomGridControlWithFilterMultiColumn();
			this.gridViewContainerActiveIngredient = new CustomGridViewWithFilterMultiColumn();
			this.popupControlContainerMedicineType = new DevExpress.XtraBars.PopupControlContainer();
			this.gridControlContainerMedicineType = new CustomGridControlWithFilterMultiColumn();
			this.gridViewContainerMedicineType = new CustomGridViewWithFilterMultiColumn();
			...
			this.btnChonKQ2.Click += new System.EventHandler(btnChonKQ_Click);
			...
			this.btnChonKQ.Click += new System.EventHandler(btnChonKQ_Click);
			...
			this.popupControlContainerActiveIngredient.Controls.Add((System.Windows.Forms.Control)(object)this.gridControlContainerActiveIngredient);
			...
			this.popupControlContainerActiveIngredient.CloseUp += new System.EventHandler(popupControlContainerActiveIngredient_CloseUp);
			((System.Windows.Forms.Control)(object)this.gridControlContainerActiveIngredient).Dock = System.Windows.Forms.DockStyle.Fill;
			((System.Windows.Forms.Control)(object)this.gridControlContainerActiveIngredient).Location = new System.Drawing.Point(0, 0);
			((DevExpress.XtraGrid.GridControl)(object)this.gridControlContainerActiveIngredient).MainView = (DevExpress.XtraGrid.Views.Base.BaseView)(object)this.gridViewContainerActiveIngredient;
			((System.Windows.Forms.Control)(object)this.gridControlContainerActiveIngredient).Name = "gridControlContainerActiveIngredient";
			((System.Windows.Forms.Control)(object)this.gridControlContainerActiveIngredient).Size = new System.Drawing.Size(252, 25);
			((System.Windows.Forms.Control)(object)this.gridControlContainerActiveIngredient).TabIndex = 0;
			((DevExpress.XtraGrid.GridControl)(object)this.gridControlContainerActiveIngredient).ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[1] { (DevExpress.XtraGrid.Views.Base.BaseView)(object)this.gridViewContainerActiveIngredient });
			((System.Windows.Forms.Control)(object)this.gridControlContainerActiveIngredient).Click += new System.EventHandler(gridControlContainerActiveIngredient_Click);
			((DevExpress.XtraGrid.Views.Grid.GridView)(object)this.gridViewContainerActiveIngredient).Appearance.HeaderPanel.Font = new System.Drawing.Font("Tahoma", 8.25f, System.Drawing.FontStyle.Bold);
			((DevExpress.XtraGrid.Views.Grid.GridView)(object)this.gridViewContainerActiveIngredient).Appearance.HeaderPanel.Options.UseFont = true;
			((DevExpress.XtraGrid.Views.Grid.GridView)(object)this.gridViewContainerActiveIngredient).FocusRectStyle = DevExpress.XtraGrid.Views.Grid.DrawFocusRectStyle.RowFullFocus;
			((DevExpress.XtraGrid.Views.Base.BaseView)(object)this.gridViewContainerActiveIngredient).GridControl = (DevExpress.XtraGrid.GridControl)(object)this.gridControlContainerActiveIngredient;
			((DevExpress.XtraGrid.Views.Base.BaseView)(object)this.gridViewContainerActiveIngredient).Name = "gridViewContainerActiveIngredient";
			((DevExpress.XtraGrid.Views.Grid.GridView)(object)this.gridViewContainerActiveIngredient).OptionsView.ShowFilterPanelMode = DevExpress.XtraGrid.Views.Base.ShowFilterPanelMode.Never;
			((DevExpress.XtraGrid.Views.Grid.GridView)(object)this.gridViewContainerActiveIngredient).OptionsView.ShowGroupPanel = false;
			((DevExpress.XtraGrid.Views.Grid.GridView)(object)this.gridViewContainerActiveIngredient).OptionsView.ShowIndicator = false;
			((DevExpress.XtraGrid.Views.Base.BaseView)(object)this.gridViewContainerActiveIngredient).KeyDown += new System.Windows.Forms.KeyEventHandler(gridViewContainerActiveIngredient_KeyDown);
			((DevExpress.XtraGrid.Views.Base.BaseView)(object)this.gridViewContainerActiveIngredient).MouseDown += new System.Windows.Forms.MouseEventHandler(gridViewContainerActiveIngredient_MouseDown);
			this.popupControlContainerMedicineType.BorderStyle = DevExpress.XtraEditors.Controls.BorderStyles.NoBorder;
			this.popupControlContainerMedicineType.Controls.Add((System.Windows.Forms.Control)(object)this.gridControlContainerMedicineType);
			...
			this.popupControlContainerMedicineType.CloseUp += new System.EventHandler(popupControlContainerMedicineType_CloseUp);
			((System.Windows.Forms.Control)(object)this.gridControlContainerMedicineType).Dock = System.Windows.Forms.DockStyle.Fill;
			((System.Windows.Forms.Control)(object)this.gridControlContainerMedicineType).Location = new System.Drawing.Point(0, 0);
			((DevExpress.XtraGrid.GridControl)(object)this.gridControlContainerMedicineType).MainView = (DevExpress.XtraGrid.Views.Base.BaseView)(object)this.gridViewContainerMedicineType;
			((System.Windows.Forms.Control)(object)this.gridControlContainerMedicineType).Name = "gridControlContainerMedicineType";
			((System.Windows.Forms.Control)(object)this.gridControlContainerMedicineType).Size = new System.Drawing.Size(252, 25);
			((System.Windows.Forms.Control)(object)this.gridControlContainerMedicineType).TabIndex = 0;
			((DevExpress.XtraGrid.GridControl)(object)this.gridControlContainerMedicineType).ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[1] { (DevExpress.XtraGrid.Views.Base.BaseView)(object)this.gridViewContainerMedicineType });
			((System.Windows.Forms.Control)(object)this.gridControlContainerMedicineType).Click += new System.EventHandler(gridControlContainerMedicineType_Click);
			((DevExpress.XtraGrid.Views.Grid.GridView)(object)this.gridViewContainerMedicineType).Appearance.HeaderPanel.Font = new System.Drawing.Font("Tahoma", 8.25f, System.Drawing.FontStyle.Bold);
			((DevExpress.XtraGrid.Views.Grid.GridView)(object)this.gridViewContainerMedicineType).Appearance.HeaderPanel.Options.UseFont = true;
			((DevExpress.XtraGrid.Views.Grid.GridView)(object)this.gridViewContainerMedicineType).FocusRectStyle = DevExpress.XtraGrid.Views.Grid.DrawFocusRectStyle.RowFullFocus;
			((DevExpress.XtraGrid.Views.Base.BaseView)(object)this.gridViewContainerMedicineType).GridControl = (DevExpress.XtraGrid.GridControl)(object)this.gridControlContainerMedicineType;
			((DevExpress.XtraGrid.Views.Base.BaseView)(object)this.gridViewContainerMedicineType).Name = "gridViewContainerMedicineType";
			((DevExpress.XtraGrid.Views.Grid.GridView)(object)this.gridViewContainerMedicineType).OptionsView.ShowFilterPanelMode = DevExpress.XtraGrid.Views.Base.ShowFilterPanelMode.Never;
			((DevExpress.XtraGrid.Views.Grid.GridView)(object)this.gridViewContainerMedicineType).OptionsView.ShowGroupPanel = false;
			((DevExpress.XtraGrid.Views.Grid.GridView)(object)this.gridViewContainerMedicineType).OptionsView.ShowIndicator = false;
			((DevExpress.XtraGrid.Views.Base.BaseView)(object)this.gridViewContainerMedicineType).KeyDown += new System.Windows.Forms.KeyEventHandler(gridViewContainerMedicineType_KeyDown);
			((DevExpress.XtraGrid.Views.Base.BaseView)(object)this.gridViewContainerMedicineType).MouseDown += new System.Windows.Forms.MouseEventHandler(gridViewContainerMedicineType_MouseDown);
			...
			this.xtraTabControl2.TabPages.AddRange(new DevExpress.XtraTab.XtraTabPage[5] { this.xtraTabPage5, this.xtraTabPage6, this.xtraTabPage7, this.xtraTabPage8, this.xtraTabPage9 });
			...
			this.xtraTabControl1.CustomHeaderButtons.AddRange(new DevExpress.XtraTab.Buttons.CustomHeaderButton[1]
			{
				new DevExpress.XtraTab.Buttons.CustomHeaderButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Glyph, "Chọn diễn biến bệnh, diễn biến CLS", -1, true, true, DevExpress.XtraEditors.ImageLocation.MiddleRight, null, appearance, "", "Chondienbien", null, true)
			});
			...
			this.xtraTabControl1.CustomHeaderButtonClick += new DevExpress.XtraTab.ViewInfo.CustomHeaderButtonEventHandler(xtraTabControl1_CustomHeaderButtonClick);
			...
			this.txtRequestContent.PreviewKeyDown += new System.Windows.Forms.PreviewKeyDownEventHandler(txtRequestContent_PreviewKeyDown);
			...
			this.txtUserManual.PreviewKeyDown += new System.Windows.Forms.PreviewKeyDownEventHandler(txtUserManual_PreviewKeyDown);
			...
			this.dtTimeUse.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[1]
			{
				new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)
			});
			this.dtTimeUse.Properties.CalendarTimeProperties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[1]
			{
				new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)
			});
			...
			this.dtTimeUse.PreviewKeyDown += new System.Windows.Forms.PreviewKeyDownEventHandler(dtTimeUse_PreviewKeyDown);
			...
			this.txtConcena.PreviewKeyDown += new System.Windows.Forms.PreviewKeyDownEventHandler(txtConcena_PreviewKeyDown);
			...
			this.txtUseForm.PreviewKeyDown += new System.Windows.Forms.PreviewKeyDownEventHandler(txtUseForm_PreviewKeyDown);
			...
			this.txtMedicineName.PreviewKeyDown += new System.Windows.Forms.PreviewKeyDownEventHandler(txtMedicineName_PreviewKeyDown);
			...
			this.cboMedcineType.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[2]
			{
				new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.DropDown),
				new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Delete, "", -1, true, false, false, DevExpress.XtraEditors.ImageLocation.MiddleCenter, null, new DevExpress.Utils.KeyShortcut(System.Windows.Forms.Keys.None), appearance2, appearanceHovered, appearancePressed, appearanceDisabled, "", null, null, true)
			});
			...
			this.cboMedcineType.ButtonClick += new DevExpress.XtraEditors.Controls.ButtonPressedEventHandler(cboMedcineType_ButtonClick);
			this.cboMedcineType.TextChanged += new System.EventHandler(cboMedcineType_TextChanged);
			this.cboMedcineType.KeyDown += new System.Windows.Forms.KeyEventHandler(cboMedcineType_KeyDown);
			this.cboMedcineType.PreviewKeyDown += new System.Windows.Forms.PreviewKeyDownEventHandler(cboMedcineType_PreviewKeyDown);
			...
			this.cboActiveIngredient.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[2]
			{
				new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.DropDown),
				new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Delete, "", -1, true, false, false, DevExpress.XtraEditors.ImageLocation.MiddleCenter, null, new DevExpress.Utils.KeyShortcut(System.Windows.Forms.Keys.None), appearance3, appearanceHovered2, appearancePressed2, appearanceDisabled2, "", null, null, true)
			});
			...
			this.cboActiveIngredient.ButtonClick += new DevExpress.XtraEditors.Controls.ButtonPressedEventHandler(cboActiveIngredient_ButtonClick);
			this.cboActiveIngredient.TextChanged += new System.EventHandler(cboActiveIngredient_TextChanged);
			this.cboActiveIngredient.KeyDown += new System.Windows.Forms.KeyEventHandler(cboActiveIngredient_KeyDown);
			this.cboActiveIngredient.PreviewKeyDown += new System.Windows.Forms.PreviewKeyDownEventHandler(cboActiveIngredient_PreviewKeyDown);
			this.layoutControlGroup1.EnableIndentsWithoutBorders = DevExpress.Utils.DefaultBoolean.True;
			this.layoutControlGroup1.GroupBordersVisible = false;
			this.layoutControlGroup1.Items.AddRange(new DevExpress.XtraLayout.BaseLayoutItem[18]
			{
				this.LciMedicineName, this.LciConcena, this.LciUseForm, this.LciRequestContent, this.layoutControlItem2, this.layoutControlItem8, this.lciForcboMedcineType, this.lciForcboActiveIngredient, this.LciServiceCode, this.LciServiceName,
				this.lciChonKQ, this.emptySpaceItem1, this.LciUserManual, this.LciTimeUse, this.lciKetQuaCLS, this.lciKetQuaCLS2, this.lciChonKQ2, this.emptySpaceItem2
			});
			...
			this.dxValidationProviderControl.ValidationFailed += new DevExpress.XtraEditors.DXErrorProvider.ValidationFailedEventHandler(dxValidationProviderControl_ValidationFailed);
			...
			base.Name = "UcOther";
			base.Size = new System.Drawing.Size(1205, 647);
			base.Load += new System.EventHandler(UcOther_Load);
