...
namespace HIS.Desktop.Plugins.DebateDiagnostic
{
	public class FormDebateDiagnostic : FormBase
	{
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(FormDebateDiagnostic));
			...
			{
				new EditorButton(ButtonPredefines.Glyph, "", -1, true, true, false, ImageLocation.MiddleCenter, (Image)componentResourceManager.GetObject("rebtnFeedBackEnable.Buttons"), new KeyShortcut(Keys.None), appearance, appearanceHovered, appearancePressed, appearanceDisabled, "Lấy ý kiến nhận xét của thành viên", null, null, true)
			});
			...
			{
				new EditorButton(ButtonPredefines.Glyph, "", -1, true, true, false, ImageLocation.MiddleCenter, (Image)componentResourceManager.GetObject("rebtnFeedBackDisable.Buttons"), new KeyShortcut(Keys.None), appearance3, appearanceHovered3, appearancePressed3, appearanceDisabled3, "Lấy ý kiến nhận xét của thành viên", null, null, true)
			});
			...
			layoutControlItem18.OptionsToolTip.ToolTip = componentResourceManager.GetString("resource.ToolTip");
			...
			((Control)(object)this).AutoSize = true;
